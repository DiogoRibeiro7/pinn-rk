...
The DOI above is the **concept DOI**: it always resolves to the latest version. To cite a specific release, use its own DOI instead — `10.5281/zenodo.21865023` for v0.5.0, `10.5281/zenodo.21860298` for v0.4.0, `10.5281/zenodo.21850047` for v0.3.0, `10.5281/zenodo.21843920` for v0.2.0, `10.5281/zenodo.21839392` for v0.1.0.
