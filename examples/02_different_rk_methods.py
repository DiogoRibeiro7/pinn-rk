...
def compare_methods(
    ...
    for method in methods:
        ...
        model, error, train_time = train_with_method(method, T, N, n_x_train, steps, lr, device)
...
def print_comparison_table(results: dict[str, dict[str, float]]) -> None:
    ...
    print(f"Fastest: {method_names[best_speed[0]]} (time = {best_speed[1]['time']:.2f}s)")
...
def main():
    ...
    parser.add_argument(
        "--methods",
        nargs="+",
        default=["gauss2", "radau2", "lobatto2"],
